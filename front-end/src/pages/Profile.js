...
const Profile = () => {
    ...
    const fetchOrder = async () => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/user/get-orders`,
                {
                    headers: {
    ...
    return (
        <>
            ...
            <Meta title="Trang cá nhân"></Meta>
            <BreadCrumb title="Trang cá nhân"></BreadCrumb>
                        ...
                        <div className="col-3">
                            ...
                            <div className="row align-items-center justify-content-center">
                                ...
                                <div className="d-flex align-items-center justify-content-center mt-2">
                                    <p className="name-user">Trần Đặng Quốc</p>
                                </div>
                                <div className="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <div className="bg-white p-3">
                                <table className="table">
                                    ...
                                    {orders.length > 0 ? orders.map(order => (
                                        <tr>
                                            <th scope="row">{convertDate(order.paymentIntent.created)}</th>
                                            <td>{formatter.format(order.paymentIntent.amount)}</td>
